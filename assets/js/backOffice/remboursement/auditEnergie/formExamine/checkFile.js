$(document).ready(function()
{
    ...
    // Event Destinataire
    $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_destinataire').change(function () {
        $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_rib').val('');
