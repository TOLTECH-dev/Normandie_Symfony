...
{
    var rib = $("#whitelabel_backofficebundle_remboursement__remboursement_auditNumerique_instruction_rib");
    ...
    if('1' == $("#is_auditeur").val()) {
        $("label[for='whitelabel_backofficebundle_remboursement__remboursement_auditNumerique_instruction_rib']").prop('for', '');
        rib.addClass('hidden');
    } else {
        checkIBAN(iban);
