...
class Orientation_structureInferieurType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class'    => Orientation_structureInferieur::class,
            'trait_choices' => null,
        ]);
    }
    ...
    {
        return 'whitelabel_backofficebundle_orientation_structure_inferieur';
    }
}
