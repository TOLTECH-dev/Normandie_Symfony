...
$(document).ready(function()
{
    ...
    data_form['iban'] = $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_iban').val();
    data_form['bic'] = $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_bic').val();
    data_form['domiciliationBancaire'] = $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_domiciliationBancaire').val();
    ...
    var objectAuditeur = $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_destinataire option[value="0 | auditeur"]');
    var objectBeneficiaire = $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_destinataire option[value="1 | beneficiaire"]');
    ...
    isDocument(true);
    $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_destinataire').on('change', function () {
