$(document).ready(function() {
     ...
     ********************************************************************
     *******************************************************************/
    var enabled_id = document.getElementById('whitelabel_backofficebundle_partenaire__partenaire_statut_enabled');
    var elt_enabled = $('#enabledPartenaire');
    ...
    if ('0' == enabled) {
        ...
        $(enabled_id).val("1");
        $('#partenaire_dateInactif').attr('value', '');
    }
    ...
    $(enabled_id).on('click', function () {
        if (enabled_id.checked) {
            ...
            $('#partenaire_dateInactif').attr('value', date_now);
            $(enabled_id).val("0");
        }
    });
});
