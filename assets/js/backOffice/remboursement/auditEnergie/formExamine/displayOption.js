$(document).ready(function()
{
    ...
    ********************************************************************
    *******************************************************************/
    var elt_chequeReasonAutre = $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_chequeReason input:last');
    var elt_isChequeConforme = $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_isChequeConforme');
    ...
    elt_chequeReasonAutre.on('click', function () {
        if (elt_chequeReasonAutre.prop('checked') == true) {
            ...
            $('#bloc-chequeCaseAutre').addClass('hidden');
            $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_chequeReasonAutre').val('');
        }
    });
    ...
    *******************************************************************/
    ...
    var elt_factureReasonAutre = $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_factureReason input:last');
    ...
    elt_factureReasonAutre.on('click', function () {
        if (elt_factureReasonAutre.prop('checked') == true) {
            ...
            $('#bloc-factureCaseAutre').addClass('hidden');
            $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_factureReasonAutre').val('');
        }
    });
    ...
    ********************************************************************
    *******************************************************************/
    var elt_ribReasonAutre = $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_ribReason input:last');
    var elt_isRibConforme = $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_isRibConforme');
    ...
    elt_ribReasonAutre.on('click', function () {
        if (elt_ribReasonAutre.prop('checked') == true) {
            ...
            $('#bloc-ribCaseAutre').addClass('hidden');
            $('#whitelabel_backofficebundle_remboursement__remboursement_auditEnergie_instruction_ribReasonAutre').val('');
        }
    });
