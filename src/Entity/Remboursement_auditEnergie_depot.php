...
#[ORM\Entity(repositoryClass: Remboursement_auditEnergie_depotRepository::class)]
#[ORM\Table(name: 'remboursement_audit_energie_depot')]
class Remboursement_auditEnergie_depot
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    public function setAudit(?UploadedFile $audit): void {
        ...
        if ($audit !== null ) {
            ...
            $this->auditUrl = $audit->guessExtension() ?: '';
            $this->auditAlt = $audit->getClientOriginalName() ?: '';
        }
    }

    public function auditGetUploadDir(): string { return 'uploads/remboursement/auditEnergie_depot'; }
