$(document).ready(function()
{
    ...
    $('.flagLoading_documentRMH_export').click(function() {
        showMessageLoading('Génération des fichiers du RMH en cours.<br>Veuillez patienter ...');
    });

    var showMessageLoading = function (message) {
