$(document).ready(function()
{
    ...
    $('tr#filterrow th[class="with_search"]').each( function () {
        var title = $(this).html();
        $(this).html( '<input type="text" placeholder="'+title+'" />' );
    });

    // DataTable
    var table = $('#table_list_partenaire').DataTable({
        "language": {
    ...
    $("#table_list_partenaire thead input").on( 'change keyup', function () {
        table
    ...
    $('tr#filterrow th[class="with_select"]').each( function (m, n) {
